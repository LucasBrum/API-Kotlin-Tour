...
class PromocaoServiceImpl: PromocaoService {
    ...
    override fun getAllByPrecoMenorQue(preco: Double, quantidadeDias: Int): List<Promocao> {
        return this.promocaoRepository.findByPrecoMenorque(preco, quantidadeDias)
    }
